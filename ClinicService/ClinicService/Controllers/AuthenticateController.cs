...
using AuthenticationRequest = ClinicService.Models.Requests.AuthenticationRequest;
using AuthenticationResponse = ClinicService.Models.Requests.AuthenticationResponse;
using SessionContext = ClinicService.Models.SessionContext;
